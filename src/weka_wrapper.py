...
def call_weka(clf, clf_params, arff_fn, weka_path='./weka-3-8-5', cv=10, seed=111):
    """
...
def eval_gene1(gene, dmatrix, targets, clf_calls, seed=111, cv=10, expdir=Path('.'), weka_path='./weka-3-8-5'):
    """
