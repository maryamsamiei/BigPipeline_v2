...
def parse_gene_eaml(vcf_fn, gene, gene_reference, samples, min_af=None, max_af=None, af_field='AF', EA_parser='canonical'):
    """
...
def parse_gene(vcf_fn, gene, gene_reference, samples, min_af=None, max_af=None, af_field='AF', EA_parser='canonical'):
    """
    Parse EA scores and compute pEA design matrix for a given gene
